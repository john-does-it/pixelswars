...
export const unitTypes: Record<UnitTypeId, UnitDefinition> = {
	'infantry-sniper': { name: 'Sniper', attack: 60, range: 2, exclusion: 1, attacks: 1, defense: 10, movement: 4, maxHealth: 100, cost: 500, captures: true, delay: 500, selectSound: 'infantry', fightSound: 'gun-battle' },
	...
	artillery: { name: 'Artillery', attack: 60, range: 3, exclusion: 1, attacks: 1, defense: 30, movement: 4, maxHealth: 120, cost: 1200, captures: false, delay: 2000, selectSound: 'artillery-touret', fightSound: 'missile-launch' },
