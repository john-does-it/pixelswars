...
export const unitTypes: Record<UnitTypeId, UnitDefinition> = {
	...
	'anti-air': { name: 'Anti-air', attack: 70, range: 2, exclusion: 0, attacks: 2, defense: 20, movement: 6, maxHealth: 120, cost: 1000, captures: false, delay: 750, selectSound: 'artillery-touret', fightSound: 'missile-launch' }
}
